    ...
    <>
      ...
      <nav className="flex items-center justify-between h-16 md:h-20 border-b border-gray-300 relative z-50 px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="hidden lg:flex flex-1 justify-center">
          <ul className="flex flex-row gap-2 font-semibold text-sm">
            {navSections.map((item) => (
              <li
                key={item.name}
                className="relative cursor-pointer px-3 py-3 hover:bg-gray-50 transition-all duration-200 rounded-full whitespace-nowrap"
        ...
        <div className="flex flex-row gap-2 md:gap-3 items-center">
          ...
          <button
            type="button"
            className="lg:hidden p-2 text-gray-800 hover:bg-gray-50 rounded-full transition-colors"
